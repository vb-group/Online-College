...
class WLSM_Menu {
	...
	public static function create_menu() {
		if ( WLSM_Helper::lm_valid() ) {
			$school_management = add_menu_page( esc_html__( 'All Management', 'school-management' ), esc_html__( 'All Management', 'school-management' ), WLSM_ADMIN_CAPABILITY, WLSM_MENU_SM, array( 'WLSM_Menu', 'school_management' ), 'dashicons-welcome-learn-more', 27 );
			...
			$schools_submenu = add_submenu_page( WLSM_MENU_SM, esc_html__( 'College', 'school-management' ), esc_html__( 'College', 'school-management' ), WLSM_ADMIN_CAPABILITY, WLSM_MENU_SCHOOLS, array( 'WLSM_Menu', 'schools' ) );
			...
			if ( ! current_user_can( WLSM_ADMIN_CAPABILITY ) && count( $user_info['schools_assigned'] ) > 1 ) {
				$schools_assigned = add_menu_page( esc_html__( 'All Management', 'school-management' ), esc_html__( 'All Management', 'school-management' ), 'read', WLSM_MENU_SCHOOLS_ASSIGNED, array( 'WLSM_Menu', 'schools_assigned' ), 'dashicons-welcome-learn-more', 27 );
			...
			if ( $current_school = $user_info['current_school'] ) {
				...
				if ( in_array( $role, array_keys( WLSM_M_Role::get_roles() ) ) ) {
					...
					// School - Menu.
					$school_staff_school_menu = add_menu_page( esc_html__( 'College', 'school-management' ), esc_html__( 'VB College', 'school-management' ), 'read', WLSM_MENU_STAFF_SCHOOL, array( 'WLSM_Menu', 'school_staff_dashboard' ), 'dashicons-building', 31 );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_classes', 'manage_subjects', 'manage_timetable', 'view_timetable',  'manage_attendance', 'manage_study_materials', 'manage_homework', 'manage_notices', 'manage_student_leaves', 'manage_events', 'manage_live_classes' ), $permissions ) ) {
						...
						$school_staff_group_academic_menu = add_menu_page( esc_html__( 'Academic', 'school-management' ), esc_html__( 'VB Academic', 'school-management' ), 'read', WLSM_MENU_STAFF_ACADEMIC, array( 'WLSM_Menu', 'school_staff_group_academic' ), 'dashicons-welcome-learn-more', 31 );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_admissions', 'manage_students', 'manage_promote', 'manage_transfer_student', 'manage_certificates', 'send_notifications' ), $permissions ) ) {
						...
						$school_staff_group_student_menu = add_menu_page( esc_html__( 'Student', 'school-management' ), esc_html__( 'VB Student', 'school-management' ), 'read', WLSM_MENU_STAFF_STUDENT, array( 'WLSM_Menu', 'school_staff_group_student' ), 'dashicons-groups', 32 );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_admins', 'manage_roles', 'manage_employees', 'manage_staff_attendance', 'manage_staff_leaves' ), $permissions ) ) {
						...
						$school_staff_group_administrator_menu = add_menu_page( esc_html__( 'Administrator', 'school-management' ), esc_html__( 'VB Administrator', 'school-management' ), 'read', WLSM_MENU_STAFF_ADMINISTRATOR, array( 'WLSM_Menu', 'school_staff_group_administrator' ), 'dashicons-businessman', 33 );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_exams' ), $permissions ) ) {
						...
						$school_staff_group_examination_menu = add_menu_page( esc_html__( 'Examination', 'school-management' ), esc_html__( 'VB Examination', 'school-management' ), 'read', WLSM_MENU_STAFF_EXAMINATION, array( 'WLSM_Menu', 'school_staff_group_examination' ), 'dashicons-clock', 33 );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_expenses', 'manage_income', 'manage_invoices', 'manage_fees' ), $permissions ) ) {
						...
						$school_staff_group_accounting_menu = add_menu_page( esc_html__( 'Accounting', 'school-management' ), esc_html__( 'VB Accounting', 'school-management' ), 'read', WLSM_MENU_STAFF_ACCOUNTING, array( 'WLSM_Menu', 'school_staff_group_accounting' ), 'dashicons-media-spreadsheet', 33 );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_library' ), $permissions ) ) {
						...
						$school_staff_group_library_menu = add_menu_page( esc_html__( 'Library', 'school-management' ), esc_html__( 'VB Library', 'school-management' ), 'read', WLSM_MENU_STAFF_LIBRARY, array( 'WLSM_Menu', 'school_staff_group_library' ), 'dashicons-book', 34 );
					...
					if ( WLSM_M_Role::check_permission( array( 'manage_transport' ), $permissions ) ) {
						...
						$school_staff_group_transport_menu = add_menu_page( esc_html__( 'Transport', 'school-management' ), esc_html__( 'VB Transport', 'school-management' ), 'read', WLSM_MENU_STAFF_TRANSPORT, array( 'WLSM_Menu', 'school_staff_group_transport' ), 'dashicons-location-alt', 34 );
			...
			$school_management_menu = add_menu_page( esc_html__( 'All Management', 'school-management' ), esc_html__( 'All Management', 'school-management' ), WLSM_ADMIN_CAPABILITY, 'school-management-license', array( 'WLSM_Menu', 'admin_menu' ), 'dashicons-welcome-learn-more', 27 );
