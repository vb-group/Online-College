									...
									<li class="list-inline-item">
										<div class="alert alert-light">
											<?php esc_html_e( 'To display exam results form on a page or post, use shortcode', 'school-management' ); ?>:<br>
												<span id="wlsm_college_management_exam_result_shortcode" class="wlsm-font-bold text-dark">[college_management_exam_result school_id="<?php echo esc_html( $school_id ); ?>" exam_id="<?php echo esc_html( $exam->ID ); ?>"]</span>
