			...
			<ul class="list-group list-group-flush">
				<li class="list-inline-item">
					<div class="alert alert-light">
						...
						?>:<br>
							<span id="wlsm_college_management_fees_default_session_shortcode" class="wlsm-font-bold text-dark">[college_management_fees school_id="<?php echo esc_html( $school_id ); ?>"]</span>
						<button id="wlsm_college_management_fees_default_session_copy_btn" class="btn btn-outline-success btn-sm" type="button">
				...
				<li class="list-inline-item">
					<div class="alert alert-light">
						<?php esc_html_e( 'To display exam time table form on a page or post, use shortcode', 'school-management' ); ?>:<br>
							<span id="wlsm_college_management_exam_time_table_shortcode" class="wlsm-font-bold text-dark">[college_management_exam_time_table school_id="<?php echo esc_html( $school_id ); ?>"]</span>
				...
				<li class="list-inline-item">
					<div class="alert alert-light">
						<?php esc_html_e( 'To display exam admit cards form on a page or post, use shortcode', 'school-management' ); ?>:<br>
							<span id="wlsm_college_management_exam_admit_card_shortcode" class="wlsm-font-bold text-dark">[college_management_exam_admit_card school_id="<?php echo esc_html( $school_id ); ?>"]</span>
