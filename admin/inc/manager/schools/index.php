		...
		<div class="wlsm-main-header card col">
			<div class="card-header">
				<h1 class="h3 text-center">
					...
					<?php esc_html_e( 'Colleges', 'school-management' ); ?>
				</h1>
				<div class="float-md-right">
					<a href="<?php echo esc_url( $page_url . '&action=save' ); ?>" class="btn btn-sm btn-primary">
						<i class="fas fa-plus-square"></i>&nbsp;
						<?php echo esc_html( 'Add New College', 'school-management' ); ?>
					</a>
				</div>
			</div>
			<div class="">
				<table class="table table-hover table-bordered" id="wlsm-schools-table">
					<thead>
						<tr class="text-white bg-primary">
							<th scope="col"><?php esc_html_e( 'College Name', 'school-management' ); ?></th>
