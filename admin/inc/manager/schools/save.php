			...
			<div class="col-md-12">
				<div class="wlsm-main-header card col wlsm-page-heading-box">
					...
					<?php } else { ?>
						...
						<?php esc_html_e( 'Add New College', 'school-management' ); ?>
					<?php } ?>
					</h1>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								<label for="wlsm_label" class="font-weight-bold"><span class="wlsm-important">*</span> <?php esc_html_e( 'College Name', 'school-management' ); ?>:</label>
								<input type="text" name="label" class="form-control" id="wlsm_label" placeholder="<?php esc_attr_e( 'Enter college name', 'school-management' ); ?>" value="<?php echo esc_attr( WLSM_M_School::get_label_text( $label ) ); ?>">
							</div>

							<div class="form-group">
								<label for="wlsm_phone" class="font-weight-bold"><?php esc_html_e( 'Phone', 'school-management' ); ?>:</label>
								<input type="text" name="phone" class="form-control" id="wlsm_phone" placeholder="<?php esc_attr_e( 'Enter college phone number', 'school-management' ); ?>" value="<?php echo esc_attr( $phone ); ?>">
							</div>

							<div class="form-group">
								<label for="wlsm_email" class="font-weight-bold"><?php esc_html_e( 'Email', 'school-management' ); ?>:</label>
								<input type="email" name="email" class="form-control" id="wlsm_email" placeholder="<?php esc_attr_e( 'Enter college email', 'school-management' ); ?>" value="<?php echo esc_attr( $email ); ?>">
							</div>

							<div class="form-group">
								<label for="wlsm_address" class="font-weight-bold"><?php esc_html_e( 'Address', 'school-management' ); ?>:</label>
								<textarea name="address" class="form-control" id="wlsm_address" rows="3" placeholder="<?php esc_attr_e( 'Enter college address', 'school-management' ); ?>"><?php echo esc_html( $address ); ?></textarea>
							</div>
				...
				<div class="col-md-12 text-center">
					<button type="submit" class="btn btn-sm btn-primary" id="wlsm-save-school-btn">
						...
						if ( $school ) {
							...
							<?php
							esc_html_e( 'Update College', 'school-management' );
						} else {
							?>
							<i class="fas fa-plus-square"></i>&nbsp;
							<?php
							esc_html_e( 'Add New College', 'school-management' );
						}
						?>
					</button>
				</div>
