						...
						<ul class="list-group list-group-flush">
							<li class="list-inline-item">
								<div class="alert alert-light">
									...
									<span id="wlsm_college_management_fees_shortcode" class="wlsm-font-bold text-dark">[college_management_fees]</span>
									<button id="wlsm_college_management_fees_copy_btn" class="btn btn-outline-success btn-sm" type="button">
							...
							<li class="list-inline-item">
								<div class="alert alert-light">
									...
									<span id="wlsm_college_management_account_shortcode" class="wlsm-font-bold text-dark">[college_management_account]</span>
									<button id="wlsm_college_management_account_copy_btn" class="btn btn-outline-success btn-sm" type="button">
										<?php esc_html_e('Copy', 'school-management'); ?>
									</button>
								</div>
							</li>
							...
							<li class="list-inline-item">
								<div class="alert alert-light">
									...
									<span id="wlsm_college_management_inquiry_shortcode" class="wlsm-font-bold text-dark">[college_management_inquiry]</span>
									<button id="wlsm_college_management_inquiry_copy_btn" class="btn btn-outline-success btn-sm" type="button">
										<?php esc_html_e('Copy', 'school-management'); ?>
									</button>
								</div>
							</li>
							...
							<li class="list-inline-item">
								<div class="alert alert-light">
									...
									<span id="wlsm_college_management_registration_shortcode" class="wlsm-font-bold text-dark">[college_management_registration]</span>
							...
							<li class="list-inline-item">
								<div class="alert alert-light">
									...
									<span id="wlsm_college_management_exam_time_table_shortcode" class="wlsm-font-bold text-dark">[college_management_exam_time_table]</span>
							...
							<li class="list-inline-item">
								<div class="alert alert-light">
									...
									<span id="wlsm_college_management_exam_admit_card_shortcode" class="wlsm-font-bold text-dark">[college_management_exam_admit_card]</span>
